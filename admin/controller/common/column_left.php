	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$furkan = array();
				...
				$furkan[] = array(
					'name'     => 'Sezinsoft',
					'href'     => $this->url->link('custom/deneme', 'user_token=' . $this->session->data['user_token'], true), 
					'children' => array()	
				);
            ...
            $gittigidiyor[] = array(
                'name'     => 'Ürün Ayarları',
                'href'     => $this->url->link('extension/module/gittigidiyor_entegrasyon/settings', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            ...
            $data['menus'][] = array(
                'id'       => 'menu-catalog',
                'icon'	   => 'fa-tags',
                'name'	   => "Oxit Gittigidiyor",
                'href'     => '',
                'children' => $gittigidiyor
            );
