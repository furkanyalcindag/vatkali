...
class ControllerCatalogProduct extends Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_extension_oxit_combine->addCombine($this->request->post, $product_id);
            $gg_add=$this->model_extension_oxit_gittigidiyor_entegrasyon->addProduct($this->request->post, $product_id);
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['product_combined'])) {
            $products1 = $this->request->post['product_combined'];
        } elseif (isset($this->request->get['product_id'])) {
            $products1 = $this->model_extension_oxit_combine->getProductCombined($this->request->get['product_id']);
        } else {
            $products1 = array();
        }

        $data['product_combineds'] = array();
